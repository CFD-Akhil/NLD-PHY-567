...
# Position for 2D circular Orbit
# Position
# The three bodies are placed at the vertices of an equilateral triangle
# centered at the origin (0,0).
inital_position_1 = [1.0, 0.0, 0.0]
inital_position_2 = [-0.5, 0.8660254, 0.0]
inital_position_3 = [-0.5, -0.8660254, 0.0]

# Velocity
# The velocities are set to keep the bodies in a perfect circular orbit
# that maintains the triangular formation.
inital_velocity_1 = [0.0, -0.7598, 0.0]
inital_velocity_2 = [0.6586, 0.3799, 0.0]
inital_velocity_3 = [-0.6586, 0.3799, 0.0]
...
time_s, time_e = 0, 20
t_points = np.linspace(time_s, time_e, 501)
...
planet3_plt, = ax.plot(p3x_sol, p3y_sol, 'blue',label='Planet 3', linewidth=1)

planet1_dot, = ax.plot([p1x_sol[-1]], [p1y_sol[-1]], 'o', color='green', markersize=6)
planet2_dot, = ax.plot([p2x_sol[-1]], [p2y_sol[-1]], 'o', color='red', markersize=6)
planet3_dot, = ax.plot([p3x_sol[-1]], [p3y_sol[-1]], 'o', color='blue', markersize=6)


ax.set_title("The 3-Body Problem (circular orbit)")
ax.set_xlabel("x")
ax.set_ylabel("y")
...
animation.save('circular.gif', writer='pillow', fps=30)
