...
# Position for 2D dragon Orbit
# Position
inital_position_1 = [0.0381, 0.5284, 0.0]
inital_position_2 = [0.5755, -0.2285, 0.0]
inital_position_3 = [-0.6136, -0.2999, 0.0]

# Velocity
inital_velocity_1 = [-0.2597, -0.5843, 0.0]
inital_velocity_2 = [0.4905, -0.4078, 0.0]
inital_velocity_3 = [-0.2307, 0.9921, 0.0]
...
ax.set_title("The 3-Body Problem (dragon orbit)")
ax.set_xlabel("x")
ax.set_ylabel("y")
...
animation.save('dragon.gif', writer='pillow', fps=30)
