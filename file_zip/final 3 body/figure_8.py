...
# Position for 2D Figure-Eight Orbit
inital_position_1 = [-0.97000436, -0.24308753, 0.0]
inital_position_2 = [0.0, 0.0, 0.0]
inital_position_3 = [0.97000436, 0.24308753, 0.0]

# Velocity for 2D Figure-Eight Orbit
inital_velocity_1 = [0.466203685, -0.43236573, 0.0]
inital_velocity_2 = [-0.93240737, 0.86473146, 0.0]
inital_velocity_3 = [0.466203685, -0.43236573, 0.0]
...
ax.set_title("The 3-Body Problem (2D Figure-Eight)")
ax.set_xlabel("x")
ax.set_ylabel("y")
...
animation.save('figure_8.gif', writer='pillow', fps=30)
